...
namespace FilmesAPI
{
    public class Startup
    {
        ...
        {
            //Essa linha para adicionar a conexão com o bando de dados msql utilizando a connections string que está no appsettings.json
            ...
            //Essa linha para usar o automapper
